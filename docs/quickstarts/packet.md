...
1. Execute [Cleanup](#cleanup) steps.
...
For failed machine provisioning on Packet end, execute the steps mentioned in the
[Cleanup](#cleanup) section and retry [Step 5.](#step-5-create-lokomotive-cluster)
...
You now have an understanding of how to create a Lokomotive cluster on Packet.

This quickstart guide did not cover configuring all the available options in the cluster configuration.
For more information, you can visit the [Packet configuration guide](docs/configuration-guides/platforms/packet.md)
