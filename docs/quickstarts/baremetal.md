...
You now have an understanding of how to create a Lokomotive cluster on baremetal.

This quickstart guide did not cover configuring all the available options in the cluster configuration.
For more information, you can visit the [Bare Metal configuration guide](docs/configuration-guides/baremetal.md)
